...
At this point, it is good to ask about the level of a school district, are each type of school crime correlated. To answer this question, we can use matrix scatter plots. We summaries the sum of each type of crime grouping by districts and school year.
